---
title: File sharing permissions in personal and organisation accounts
slug: file-sharing-permissions-in-personal-and-organisation-accounts
category: gitlaw-how-to-guides
excerpt: Understand how visibility and permissions work on GitLaw. Learn about organisation roles, document-level access, sharing with external parties, and general access settings.
---
...
- **Only people you invite (default):** only people you have explicitly invited can open the document.
- **Organisation:** anyone in your organisation can view the document.
- **Anyone with the link:** anyone holding the link can view the document, including people who are not signed in.
...
Yes. Choose from Only people you invite, Organisation, Anyone with the link, or Public.

---

See how to set up your GitLaw account [here](https://git.law/knowledge-base/set-up-your-gitlaw-account).
See how to add a new file to GitLaw [here](https://git.law/knowledge-base/how-to-add-a-new-file-to-gitlaw).
See how to contribute to an existing doc repository [here](https://git.law/knowledge-base/how-to-contribute-to-an-existing-doc-repository-on-gitlaw).
